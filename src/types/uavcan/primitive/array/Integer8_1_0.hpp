...
// Generated at:  2023-01-29 16:46:55.742303 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Integer8_1_0 final
{
    ...
    nunavut::support::VariableLengthArray<std::int8_t, 256> value{};
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated int8[<=256] value
            ...
            for (size_t _index2_ = 0U; _index2_ < value.size(); ++_index2_)
            {
                ...
                const auto _result3_ = out_buffer.setIxx(value[_index2_], 8U);
                if(not _result3_){
                    return -_result3_.error();
                }
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            for (size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
            {
                ...
                value.push_back();
                NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            value[_index5_] = in_buffer.getI8(8U);
