...
// Generated at:  2023-03-10 05:17:53.803234 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Bit_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using value = nunavut::support::VariableLengthArray<bool, 2048>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const Bit_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated bool[<=2048] value
        ...
        {
            auto _result2_ = out_buffer.setBit(obj.value[_index2_]);
            if(not _result2_){
...
inline nunavut::support::SerializeResult deserialize(Bit_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    in_buffer.add_offset(16U);
        ...
        for (std::size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
        {
            ...
            obj.value.push_back();
            obj.value[_index5_] = in_buffer.getBit();
