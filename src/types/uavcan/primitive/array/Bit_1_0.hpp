...
// Source file:   /tmp/public_regulated_data_types/uavcan/primitive/array/Bit.1.0.dsdl
// Generated at:  2023-01-24 05:52:11.041683 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     Uses std_variant:no
#ifndef UAVCAN_PRIMITIVE_ARRAY_BIT_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/primitive/array/Bit.1.0.dsdl "
...
struct Bit_1_0 final
{
    ...
    nunavut::support::VariableLengthArray<bool, 2048> value;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated bool[<=2048] value
            ...
            for (size_t _index2_ = 0U; _index2_ < value.size(); ++_index2_)
            {
                ...
                auto _result2_ = out_buffer.setBit(value[_index2_]);
                if(not _result2_){
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            for (size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
            {
                ...
                value.push_back();
                value[_index5_] = in_buffer.getBit();
...
#endif // UAVCAN_PRIMITIVE_ARRAY_BIT_1_0_HPP_INCLUDED
