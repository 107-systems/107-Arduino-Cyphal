...
// Generated at:  2023-03-10 05:17:53.805495 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Integer16_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using value = nunavut::support::VariableLengthArray<std::int16_t, 128>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const Integer16_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated int16[<=128] value
        ...
        for (std::size_t _index2_ = 0U; _index2_ < obj.value.size(); ++_index2_)
        {
            ...
            const auto _result3_ = out_buffer.setIxx(obj.value[_index2_], 16U);
            if(not _result3_){
                return -_result3_.error();
            }
...
inline nunavut::support::SerializeResult deserialize(Integer16_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    in_buffer.add_offset(8U);
        ...
        for (std::size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
        {
            ...
            obj.value.push_back();
            obj.value[_index5_] = in_buffer.getI16(16U);
