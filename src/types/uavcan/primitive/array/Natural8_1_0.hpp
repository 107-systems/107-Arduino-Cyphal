...
// Source file:   /tmp/public_regulated_data_types/uavcan/primitive/array/Natural8.1.0.dsdl
// Generated at:  2023-01-29 16:46:55.753065 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     Uses std_variant:no
#ifndef UAVCAN_PRIMITIVE_ARRAY_NATURAL8_1_0_HPP_INCLUDED
#define UAVCAN_PRIMITIVE_ARRAY_NATURAL8_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/primitive/array/Natural8.1.0.dsdl "
...
struct Natural8_1_0 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =258UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =258UL;
    ...
    nunavut::support::VariableLengthArray<std::uint8_t, 256> value{};
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated uint8[<=256] value
            ...
            const auto _result3_ = out_buffer.setUxx(value.size(), 16U);
            if(not _result3_){
            ...
            for (size_t _index2_ = 0U; _index2_ < value.size(); ++_index2_)
            {
                ...
                const auto _result3_ = out_buffer.setUxx(value[_index2_], 8U);
                if(not _result3_){
                    return -_result3_.error();
                }
        ...
        NUNAVUT_ASSERT(out_buffer.offset() <= 2064ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            for (size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
            {
                ...
                value.push_back();
                NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            value[_index5_] = in_buffer.getU8(8U);
...
#endif // UAVCAN_PRIMITIVE_ARRAY_NATURAL8_1_0_HPP_INCLUDED
