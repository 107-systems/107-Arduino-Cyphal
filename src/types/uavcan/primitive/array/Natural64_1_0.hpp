...
// Source file:   /tmp/public_regulated_data_types/uavcan/primitive/array/Natural64.1.0.dsdl
// Generated at:  2023-01-24 05:52:11.060063 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     Uses std_variant:no
#ifndef UAVCAN_PRIMITIVE_ARRAY_NATURAL64_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/primitive/array/Natural64.1.0.dsdl "
...
struct Natural64_1_0 final
{
    ...
    nunavut::support::VariableLengthArray<std::uint64_t, 32> value;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated uint64[<=32] value
            ...
            for (size_t _index2_ = 0U; _index2_ < value.size(); ++_index2_)
            {
                ...
                const auto _result3_ = out_buffer.setUxx(value[_index2_], 64U);
                if(not _result3_){
                    return -_result3_.error();
                }
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            for (size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
            {
                ...
                value.push_back();
                NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            value[_index5_] = in_buffer.getU64(64U);
...
#endif // UAVCAN_PRIMITIVE_ARRAY_NATURAL64_1_0_HPP_INCLUDED
