...
// Source file:   /tmp/public_regulated_data_types/uavcan/primitive/array/Natural32.1.0.dsdl
// Generated at:  2023-01-29 16:46:55.747705 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     Uses std_variant:no
#ifndef UAVCAN_PRIMITIVE_ARRAY_NATURAL32_1_0_HPP_INCLUDED
#define UAVCAN_PRIMITIVE_ARRAY_NATURAL32_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/primitive/array/Natural32.1.0.dsdl "
...
struct Natural32_1_0 final
{
    ...
    nunavut::support::VariableLengthArray<std::uint32_t, 64> value{};
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated uint32[<=64] value
            ...
            for (size_t _index2_ = 0U; _index2_ < value.size(); ++_index2_)
            {
                ...
                const auto _result3_ = out_buffer.setUxx(value[_index2_], 32U);
                if(not _result3_){
                    return -_result3_.error();
                }
...
#endif // UAVCAN_PRIMITIVE_ARRAY_NATURAL32_1_0_HPP_INCLUDED
