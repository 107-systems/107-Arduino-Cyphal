...
// Source file:   /tmp/public_regulated_data_types/uavcan/primitive/array/Real32.1.0.dsdl
// Generated at:  2023-01-18 06:06:50.685909 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     Uses std_variant:no
#ifndef UAVCAN_PRIMITIVE_ARRAY_REAL32_1_0_HPP_INCLUDED
#define UAVCAN_PRIMITIVE_ARRAY_REAL32_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/primitive/array/Real32.1.0.dsdl "
...
struct Real32_1_0 final
{
    ...
    nunavut::support::VariableLengthArray<float, 64> value;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated float32[<=64] value
            ...
            for (size_t _index2_ = 0U; _index2_ < value.size(); ++_index2_)
            {
                ...
                auto _result4_ = out_buffer.setF32(value[_index2_]);
                if(not _result4_){
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            for (size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
            {
                ...
                value.push_back();
                NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            value[_index5_] = in_buffer.getF32();
...
#endif // UAVCAN_PRIMITIVE_ARRAY_REAL32_1_0_HPP_INCLUDED
