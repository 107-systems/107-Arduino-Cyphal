...
// Generated at:  2023-03-10 05:17:53.825412 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Real32_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using value = nunavut::support::VariableLengthArray<float, 64>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const Real32_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated float32[<=64] value
        ...
        for (std::size_t _index2_ = 0U; _index2_ < obj.value.size(); ++_index2_)
        {
            ...
            auto _result4_ = out_buffer.setF32(obj.value[_index2_]);
            if(not _result4_){
...
inline nunavut::support::SerializeResult deserialize(Real32_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    in_buffer.add_offset(8U);
        ...
        for (std::size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
        {
            ...
            obj.value.push_back();
            obj.value[_index5_] = in_buffer.getF32();
