...
// Source file:   /tmp/public_regulated_data_types/uavcan/primitive/array/Natural16.1.0.dsdl
// Generated at:  2023-01-18 06:33:56.041646 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     Uses std_variant:no
#ifndef UAVCAN_PRIMITIVE_ARRAY_NATURAL16_1_0_HPP_INCLUDED
#define UAVCAN_PRIMITIVE_ARRAY_NATURAL16_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/primitive/array/Natural16.1.0.dsdl "
...
struct Natural16_1_0 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =257UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =257UL;
    ...
    nunavut::support::VariableLengthArray<std::uint16_t, 128> value;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated uint16[<=128] value
            ...
            const auto _result3_ = out_buffer.setUxx(value.size(), 8U);
            if(not _result3_){
                return -_result3_.error();
            }
            out_buffer.add_offset(8U);
            NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
            for (size_t _index2_ = 0U; _index2_ < value.size(); ++_index2_)
            {
                NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
                NUNAVUT_ASSERT(16ULL <= out_buffer.size());
                // Saturation code not emitted -- native representation matches the serialized representation.
                const auto _result3_ = out_buffer.setUxx(value[_index2_], 16U);
                if(not _result3_){
                    return -_result3_.error();
                }
        ...
        NUNAVUT_ASSERT(out_buffer.offset() <= 2056ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            for (size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
            {
                ...
                value.push_back();
                NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            value[_index5_] = in_buffer.getU16(16U);
...
#endif // UAVCAN_PRIMITIVE_ARRAY_NATURAL16_1_0_HPP_INCLUDED
