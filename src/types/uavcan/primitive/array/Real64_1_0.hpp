...
// Source file:   /tmp/public_regulated_data_types/uavcan/primitive/array/Real64.1.0.dsdl
// Generated at:  2023-01-24 05:52:11.070572 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/primitive/array/Real64.1.0.dsdl "
...
struct Real64_1_0 final
{
    ...
    nunavut::support::VariableLengthArray<double, 32> value;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated float64[<=32] value
            ...
            for (size_t _index2_ = 0U; _index2_ < value.size(); ++_index2_)
            {
                ...
                auto _result4_ = out_buffer.setF64(value[_index2_]);
                if(not _result4_){
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            for (size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
            {
                ...
                value.push_back();
                NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            value[_index5_] = in_buffer.getF64();
