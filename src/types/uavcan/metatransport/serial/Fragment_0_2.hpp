...
// Generated at:  2023-01-29 16:46:55.342679 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Fragment_0_2 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =2050UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =2050UL;
    ...
    nunavut::support::VariableLengthArray<std::uint8_t, 2048> data{};
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated uint8[<=2048] data
            NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
            NUNAVUT_ASSERT(16400ULL <= out_buffer.size());
            if (data.size() > 2048)
            {
        ...
        NUNAVUT_ASSERT(out_buffer.offset() <= 16400ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
