...
// Generated at:  2023-03-10 05:17:53.439011 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/metatransport/serial/Fragment.0.2.dsdl "
...
struct Fragment_0_2 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 2050UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 2050UL;
        static_assert(ExtentBytes >= SerializationBufferSizeBytes, "Internal constraint violation");
        static_assert(ExtentBytes < (std::numeric_limits<std::size_t>::max() / 8U), "This message is too large to be handled by the selected types");
        struct TypeOf
        {
            TypeOf() = delete;
            using data = nunavut::support::VariableLengthArray<std::uint8_t, 2048>;
        };
    };
    ...
    static constexpr std::uint16_t CAPACITY_BYTES = 2048U;
...
inline nunavut::support::SerializeResult serialize(const Fragment_0_2& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    const std::size_t capacity_bits = out_buffer.size();
    if ((static_cast<std::size_t>(capacity_bits)) < 16400UL)
    {
...
inline nunavut::support::SerializeResult deserialize(Fragment_0_2& obj,
...
#endif // UAVCAN_METATRANSPORT_SERIAL_FRAGMENT_0_2_HPP_INCLUDED
