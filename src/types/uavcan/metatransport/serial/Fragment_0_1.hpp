...
// Generated at:  2023-01-24 05:52:11.365689 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
struct Fragment_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =265UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =265UL;
    ...
    nunavut::support::VariableLengthArray<std::uint8_t, 256> data;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        NUNAVUT_ASSERT(out_buffer.offset() <= 2120ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
