...
// Generated at:  2023-01-24 05:52:11.376421 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct DataClassic_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =14UL;
    ...
    uavcan::metatransport::can::ArbitrationID_0_1 arbitration_id;

    nunavut::support::VariableLengthArray<std::uint8_t, 8> data;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // uavcan.metatransport.can.ArbitrationID.0.1 arbitration_id
            ...
            auto _err0_ = arbitration_id.serialize(_subspan0_.value());
            if (not _err0_)
            {
                return _err0_;
            }
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() >= 48ULL);
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        {
            ...
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            {
                const auto _err1_ = arbitration_id.deserialize(in_buffer.subspan());
                if(_err1_){
