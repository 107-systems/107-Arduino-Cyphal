...
// Generated at:  2023-01-29 16:46:55.296950 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct DataFD_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =70UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =70UL;
    ...
    nunavut::support::VariableLengthArray<std::uint8_t, 64> data{};
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        NUNAVUT_ASSERT(out_buffer.offset() <= 560ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
