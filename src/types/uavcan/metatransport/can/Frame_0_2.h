...
// Source file:   /tmp/public_regulated_data_types/uavcan/metatransport/can/Frame.0.2.uavcan
// Generated at:  2021-09-27 06:53:04.499917 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/metatransport/can/Frame.0.2.uavcan is trying to use a serialization library that was compiled with "
...
static inline int8_t uavcan_metatransport_can_Frame_0_2_deserialize_(
    uavcan_metatransport_can_Frame_0_2* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
