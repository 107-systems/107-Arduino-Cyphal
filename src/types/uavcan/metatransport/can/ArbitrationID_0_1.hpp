...
// Generated at:  2023-03-10 05:17:53.451572 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct ArbitrationID_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using base = uavcan::metatransport::can::BaseArbitrationID_0_1;
            using extended = uavcan::metatransport::can::ExtendedArbitrationID_0_1;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const ArbitrationID_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    using VariantType = ArbitrationID_0_1::VariantType;
...
inline nunavut::support::SerializeResult deserialize(ArbitrationID_0_1& obj,
