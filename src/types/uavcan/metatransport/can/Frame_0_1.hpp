...
// Source file:   /tmp/public_regulated_data_types/uavcan/metatransport/can/Frame.0.1.dsdl
// Generated at:  2024-01-12 03:09:34.840643 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
#ifndef UAVCAN_METATRANSPORT_CAN_FRAME_0_1_HPP_INCLUDED
#define UAVCAN_METATRANSPORT_CAN_FRAME_0_1_HPP_INCLUDED

#include <nunavut/support/serialization.hpp>
#include <types/uavcan/metatransport/can/Manifestation_0_1.hpp>
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/metatransport/can/Frame.0.1.dsdl "
...
///
struct [[deprecated("uavcan.metatransport.can.Frame.0.1 is reaching the end of its life; there may be a newer version available")]]Frame_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 78UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 78UL;
        ...
        struct TypeOf
        {
            ...
            using manifestation = uavcan::metatransport::can::Manifestation_0_1;
        };
    };
    ...
    _traits_::TypeOf::manifestation manifestation{};
};
                                                   ...
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    if ((static_cast<std::size_t>(capacity_bits)) < 624UL)
    {
    ...
    {   // uavcan.metatransport.can.Manifestation.0.1 manifestation
        std::size_t _size_bytes0_ = 71UL;  // Nested object (max) size, in bytes.
        auto _subspan0_ = out_buffer.subspan(0U, _size_bytes0_ * 8U);
        if(not _subspan0_){
            return -_subspan0_.error();
        }
        auto _err0_ = serialize(obj.manifestation, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
                                                     ...
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // uavcan.metatransport.can.Manifestation.0.1 manifestation
    {
        std::size_t _size_bytes1_ = in_buffer.size() / 8U;
        {
            const auto _err1_ = deserialize(obj.manifestation, in_buffer.subspan());
            if(_err1_){
                _size_bytes1_ = _err1_.value();
            }else{
                return -_err1_.error();
...
#endif // UAVCAN_METATRANSPORT_CAN_FRAME_0_1_HPP_INCLUDED
