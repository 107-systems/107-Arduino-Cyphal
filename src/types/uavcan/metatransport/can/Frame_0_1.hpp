...
// Generated at:  2023-01-29 16:46:55.312411 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
struct Frame_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =78UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =78UL;
    ...
    uavcan::metatransport::can::Manifestation_0_1 manifestation;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // uavcan.metatransport.can.Manifestation.0.1 manifestation
            NUNAVUT_ASSERT(out_buffer.offset_alings_to(8U));
            NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
            NUNAVUT_ASSERT(568ULL <= out_buffer.size());
            ...
            NUNAVUT_ASSERT(_subspan0_->offset_alings_to_byte());
            auto _err0_ = manifestation.serialize(_subspan0_.value());
            if (not _err0_)
            {
                return _err0_;
            }
            ...
            NUNAVUT_ASSERT((_size_bytes0_ * 8U) <= 568ULL);
            out_buffer.add_offset(_size_bytes0_ * 8U);
            // NUNAVUT_ASSERT(out_buffer.size() >= 0);
        }
        {
        ...
        NUNAVUT_ASSERT(out_buffer.offset() <= 624ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        {
            ...
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            {
                const auto _err1_ = manifestation.deserialize(in_buffer.subspan());
                if(_err1_){
                    _size_bytes1_ = _err1_.value();
                }else{
                    return -_err1_.error();
