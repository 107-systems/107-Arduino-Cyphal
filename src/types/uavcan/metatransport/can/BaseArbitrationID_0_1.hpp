...
// Generated at:  2023-01-24 05:52:11.374050 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct BaseArbitrationID_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =4UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =4UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // truncated uint11 value
            NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
            NUNAVUT_ASSERT(11ULL <= out_buffer.size());
            const auto _result3_ = out_buffer.setUxx(value, 11U);
            if(not _result3_){
        ...
        {   // void21
            NUNAVUT_ASSERT(21ULL <= out_buffer.size());
