...
// Generated at:  2023-01-24 05:52:11.385125 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct ExtendedArbitrationID_0_1 final
{
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // truncated uint29 value
            NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
            NUNAVUT_ASSERT(29ULL <= out_buffer.size());
            const auto _result3_ = out_buffer.setUxx(value, 29U);
            if(not _result3_){
