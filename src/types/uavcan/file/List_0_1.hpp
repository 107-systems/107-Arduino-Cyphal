...
// Generated at:  2024-03-22 13:17:26.716273 UTC
// Is deprecated: yes
// Fixed port-ID: 406
...
///
struct [[deprecated("uavcan.file.List.Request.0.1 is reaching the end of its life; there may be a newer version available")]]Request_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        struct TypeOf
        {
            ...
            using directory_path = uavcan::file::Path_1_0;
        };
    };
...
struct [[deprecated("uavcan.file.List.Response.0.1 is reaching the end of its life; there may be a newer version available")]]Response_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        _traits_() = delete;
        ...
        /// is always known during serialization (unlike deserialization). If not sure, use extent everywhere.
        static constexpr std::size_t ExtentBytes                  = 300UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 117UL;
        static_assert(ExtentBytes >= SerializationBufferSizeBytes, "Internal constraint violation");
        static_assert(ExtentBytes < (std::numeric_limits<std::size_t>::max() / 8U), "This message is too large to be handled by the selected types");
        ...
        {
            TypeOf() = delete;
            using entry_base_name = uavcan::file::Path_1_0;
        };
    };
...
struct List_0_1
{
    ...
    using Request  = List::Request_0_1;
    using Response = List::Response_0_1;
