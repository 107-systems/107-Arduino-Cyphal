...
// Generated at:  2023-01-24 05:52:11.297805 UTC
// Is deprecated: yes
// Fixed port-ID: 408
...
#ifndef UAVCAN_FILE_READ_1_0_HPP_INCLUDED
...
struct Request_1_0 final
{
    ...
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =118UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        if ((static_cast<std::size_t>(capacity_bits)) < 944UL)
        {
        ...
        NUNAVUT_ASSERT(out_buffer.offset() <= 944ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
...
#endif // UAVCAN_FILE_READ_1_0_HPP_INCLUDED
