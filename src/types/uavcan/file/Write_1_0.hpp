...
// Generated at:  2024-01-12 03:09:34.909941 UTC
// Is deprecated: yes
// Fixed port-ID: 409
...
///
struct [[deprecated("uavcan.file.Write.Request.1.0 is reaching the end of its life; there may be a newer version available")]]Request_1_0 final
{
...
struct [[deprecated("uavcan.file.Write.Response.1.0 is reaching the end of its life; there may be a newer version available")]]Response_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        _traits_() = delete;
