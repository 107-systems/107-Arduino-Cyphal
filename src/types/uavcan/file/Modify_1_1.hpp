...
// Generated at:  2023-01-18 06:06:50.781847 UTC
// Is deprecated: no
// Fixed port-ID: 407
...
//     Uses std_variant:no
#ifndef UAVCAN_FILE_MODIFY_1_1_HPP_INCLUDED
#define UAVCAN_FILE_MODIFY_1_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/file/407.Modify.1.1.dsdl "
...
struct Request_1_1 final
{
    ...
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =516UL;
    ...
    uavcan::file::Path_2_0 destination;

    nunavut::support::SerializeResult
    serialize(nunavut::support::bitspan out_buffer) const
    {
        const std::size_t capacity_bits = out_buffer.size();
        if ((static_cast<std::size_t>(capacity_bits)) < 4128UL)
        {
        ...
        {   // saturated bool preserve_source
            ...
            auto _result2_ = out_buffer.setBit(preserve_source);
            if(not _result2_){
        ...
        {   // saturated bool overwrite_destination
            NUNAVUT_ASSERT(1ULL <= out_buffer.size());
            auto _result2_ = out_buffer.setBit(overwrite_destination);
            if(not _result2_){
                return -_result2_.error();
            }
            out_buffer.add_offset(1UL);
        ...
        {   // void30
            NUNAVUT_ASSERT(30ULL <= out_buffer.size());
        ...
        NUNAVUT_ASSERT(out_buffer.offset() <= 4128ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        preserve_source = in_buffer.getBit();
        in_buffer.add_offset(1U);
        // saturated bool overwrite_destination
        overwrite_destination = in_buffer.getBit();
        in_buffer.add_offset(1U);
        // void30
...
struct Service_1_1 {
    ...
    using Request = Request_1_1;
    using Response = Response_1_1;
};
...
#endif // UAVCAN_FILE_MODIFY_1_1_HPP_INCLUDED
