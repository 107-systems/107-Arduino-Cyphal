...
// Generated at:  2023-03-10 05:17:53.504957 UTC
// Is deprecated: no
// Fixed port-ID: 407
...
struct Request_1_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t SerializationBufferSizeBytes = 516UL;
        ...
        struct TypeOf
        {
            ...
            using source = uavcan::file::Path_2_0;
            using destination = uavcan::file::Path_2_0;
        };
    };
...
struct Modify_1_1
{
    ...
    using Request  = Modify::Request_1_1;
    using Response = Modify::Response_1_1;
