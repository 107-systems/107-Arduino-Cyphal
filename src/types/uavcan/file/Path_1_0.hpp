...
// Generated at:  2023-03-10 05:17:53.516879 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
///
[[deprecated("uavcan.file.Path.1.0 is reaching the end of its life; there may be a newer version available")]]
struct Path_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 113UL;
        ...
        {
            TypeOf() = delete;
            using path = nunavut::support::VariableLengthArray<std::uint8_t, 112>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const Path_1_0& obj,
...
inline nunavut::support::SerializeResult deserialize(Path_1_0& obj,
