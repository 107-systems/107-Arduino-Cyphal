...
// Source file:   /tmp/public_regulated_data_types/uavcan/si/sample/magnetic_field_strength/Vector3.1.0.dsdl
// Generated at:  2024-01-29 05:34:30.571699 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
#ifndef UAVCAN_SI_SAMPLE_MAGNETIC_FIELD_STRENGTH_VECTOR3_1_0_HPP_INCLUDED
#define UAVCAN_SI_SAMPLE_MAGNETIC_FIELD_STRENGTH_VECTOR3_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/si/sample/magnetic_field_strength/Vector3.1.0.dsdl "
...
struct [[deprecated("uavcan.si.sample.magnetic_field_strength.Vector3.1.0 is reaching the end of its life; there may be a newer version available")]]Vector3_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 19UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 19UL;
    ...
    _traits_::TypeOf::tesla tesla{};
};

inline nunavut::support::SerializeResult serialize(const Vector3_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated float32[3] tesla
        ...
        for (std::size_t _index1_ = 0U; _index1_ < 3UL; ++_index1_)
        {
            ...
            auto _result4_ = out_buffer.setF32(obj.tesla[_index1_]);
            if(not _result4_){
...
inline nunavut::support::SerializeResult deserialize(Vector3_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    {
        obj.tesla[_index4_] = in_buffer.getF32();
...
#endif // UAVCAN_SI_SAMPLE_MAGNETIC_FIELD_STRENGTH_VECTOR3_1_0_HPP_INCLUDED
