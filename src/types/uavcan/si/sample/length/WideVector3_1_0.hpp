...
// Generated at:  2023-01-18 06:33:55.618145 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct WideVector3_1_0 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =31UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =31UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated float64[3] meter
            ...
            for (size_t _index1_ = 0U; _index1_ < 3UL; ++_index1_)
            {
                ...
                auto _result4_ = out_buffer.setF64(meter[_index1_]);
                if(not _result4_){
            ...
            // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
            NUNAVUT_ASSERT((out_buffer.offset() - _origin0_) == 192ULL);
            (void) _origin0_;
        }
        {
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() == 248ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        {
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            meter[_index4_] = in_buffer.getF64();
