...
// Source file:   /tmp/public_regulated_data_types/uavcan/si/sample/length/WideVector3.1.0.dsdl
// Generated at:  2023-03-10 05:17:53.742501 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef UAVCAN_SI_SAMPLE_LENGTH_WIDE_VECTOR3_1_0_HPP_INCLUDED
#define UAVCAN_SI_SAMPLE_LENGTH_WIDE_VECTOR3_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/si/sample/length/WideVector3.1.0.dsdl "
...
struct WideVector3_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        struct TypeOf
        {
            ...
            using meter = std::array<double,3>;
        };
    };
    ...
    _traits_::TypeOf::meter meter{};
};

inline nunavut::support::SerializeResult serialize(const WideVector3_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated float64[3] meter
        ...
        for (std::size_t _index1_ = 0U; _index1_ < 3UL; ++_index1_)
        {
            ...
            auto _result4_ = out_buffer.setF64(obj.meter[_index1_]);
            if(not _result4_){
...
inline nunavut::support::SerializeResult deserialize(WideVector3_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    {
        obj.meter[_index4_] = in_buffer.getF64();
...
#endif // UAVCAN_SI_SAMPLE_LENGTH_WIDE_VECTOR3_1_0_HPP_INCLUDED
