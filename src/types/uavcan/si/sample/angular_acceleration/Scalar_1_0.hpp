...
// Source file:   /tmp/public_regulated_data_types/uavcan/si/sample/angular_acceleration/Scalar.1.0.dsdl
// Generated at:  2023-01-18 06:33:55.548710 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     Uses std_variant:no
#ifndef UAVCAN_SI_SAMPLE_ANGULAR_ACCELERATION_SCALAR_1_0_HPP_INCLUDED
#define UAVCAN_SI_SAMPLE_ANGULAR_ACCELERATION_SCALAR_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/si/sample/angular_acceleration/Scalar.1.0.dsdl "
...
struct Scalar_1_0 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =11UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =11UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated float32 radian_per_second_per_second
            ...
            auto _result4_ = out_buffer.setF32(radian_per_second_per_second);
            if(not _result4_){
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() == 88ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        // saturated float32 radian_per_second_per_second
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        radian_per_second_per_second = in_buffer.getF32();
...
#endif // UAVCAN_SI_SAMPLE_ANGULAR_ACCELERATION_SCALAR_1_0_HPP_INCLUDED
