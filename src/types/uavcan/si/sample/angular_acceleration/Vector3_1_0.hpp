...
// Generated at:  2023-03-10 05:17:53.701844 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef UAVCAN_SI_SAMPLE_ANGULAR_ACCELERATION_VECTOR3_1_0_HPP_INCLUDED
#define UAVCAN_SI_SAMPLE_ANGULAR_ACCELERATION_VECTOR3_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/si/sample/angular_acceleration/Vector3.1.0.dsdl "
...
struct Vector3_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        struct TypeOf
        {
            ...
            using radian_per_second_per_second = std::array<float,3>;
        };
    };
    ...
    _traits_::TypeOf::radian_per_second_per_second radian_per_second_per_second{};
};
                                                   ...
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated float32[3] radian_per_second_per_second
        ...
        for (std::size_t _index1_ = 0U; _index1_ < 3UL; ++_index1_)
        {
            ...
            auto _result4_ = out_buffer.setF32(obj.radian_per_second_per_second[_index1_]);
            if(not _result4_){
                                                     ...
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    {
        obj.radian_per_second_per_second[_index4_] = in_buffer.getF32();
...
#endif // UAVCAN_SI_SAMPLE_ANGULAR_ACCELERATION_VECTOR3_1_0_HPP_INCLUDED
