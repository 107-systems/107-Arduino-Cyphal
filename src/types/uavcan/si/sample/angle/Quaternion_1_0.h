...
// Source file:   /tmp/public_regulated_data_types/uavcan/si/sample/angle/Quaternion.1.0.uavcan
// Generated at:  2021-09-27 06:53:04.511767 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/si/sample/angle/Quaternion.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const uavcan_si_sample_angle_Quaternion_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated float32[4] wxyz
        ...
        for (size_t _index0_ = 0U; _index0_ < 4UL; ++_index0_)
        {
            ...
            const int8_t _err1_ = nunavutSetF32(&buffer[0], capacity_bytes, offset_bits, obj->wxyz[_index0_]);
            if (_err1_ < 0)
            {
                return _err1_;
            }
    ...
    uavcan_si_sample_angle_Quaternion_1_0* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    {
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        out_obj->wxyz[_index1_] = nunavutGetF32(&buffer[0], capacity_bytes, offset_bits);
        offset_bits += 32U;
    }
