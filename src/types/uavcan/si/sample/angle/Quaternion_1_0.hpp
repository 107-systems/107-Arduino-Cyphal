...
// Source file:   /tmp/public_regulated_data_types/uavcan/si/sample/angle/Quaternion.1.0.dsdl
// Generated at:  2023-01-29 16:46:55.585804 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     Uses std_variant:no
#ifndef UAVCAN_SI_SAMPLE_ANGLE_QUATERNION_1_0_HPP_INCLUDED
#define UAVCAN_SI_SAMPLE_ANGLE_QUATERNION_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/si/sample/angle/Quaternion.1.0.dsdl "
...
struct Quaternion_1_0 final
{
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated float32[4] wxyz
            ...
            for (size_t _index1_ = 0U; _index1_ < 4UL; ++_index1_)
            {
                ...
                auto _result4_ = out_buffer.setF32(wxyz[_index1_]);
                if(not _result4_){
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        {
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            wxyz[_index4_] = in_buffer.getF32();
...
#endif // UAVCAN_SI_SAMPLE_ANGLE_QUATERNION_1_0_HPP_INCLUDED
