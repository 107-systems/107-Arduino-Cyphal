...
// Generated at:  2023-01-18 06:06:50.525313 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Vector3_1_0 final
{
    ...
    std::array<float,3> meter_per_second;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated float32[3] meter_per_second
            ...
            for (size_t _index1_ = 0U; _index1_ < 3UL; ++_index1_)
            {
                ...
                auto _result4_ = out_buffer.setF32(meter_per_second[_index1_]);
                if(not _result4_){
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        {
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            meter_per_second[_index4_] = in_buffer.getF32();
