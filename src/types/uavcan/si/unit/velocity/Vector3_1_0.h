...
// Source file:   /tmp/public_regulated_data_types/uavcan/si/unit/velocity/Vector3.1.0.uavcan
// Generated at:  2021-09-27 06:53:04.591460 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/si/unit/velocity/Vector3.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const uavcan_si_unit_velocity_Vector3_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated float32[3] meter_per_second
        ...
        for (size_t _index0_ = 0U; _index0_ < 3UL; ++_index0_)
        {
            ...
            const int8_t _err0_ = nunavutSetF32(&buffer[0], capacity_bytes, offset_bits, obj->meter_per_second[_index0_]);
            if (_err0_ < 0)
            {
                return _err0_;
            }
