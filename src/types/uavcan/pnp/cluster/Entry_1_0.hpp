...
// Generated at:  2023-01-18 06:33:55.802570 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Entry_1_0 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =22UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =22UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // uavcan.node.ID.1.0 node_id
            ...
            auto _err0_ = node_id.serialize(_subspan0_.value());
            if (not _err0_)
            {
                return _err0_;
            }
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() == 176ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        {
            ...
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            {
                const auto _err1_ = node_id.deserialize(in_buffer.subspan());
                if(_err1_){
