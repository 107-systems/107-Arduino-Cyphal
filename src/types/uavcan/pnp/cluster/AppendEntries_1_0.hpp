...
// Generated at:  2024-01-12 03:09:34.954907 UTC
// Is deprecated: no
// Fixed port-ID: 390
...
struct Request_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        struct TypeOf
        {
            ...
            using entries = std::vector<uavcan::pnp::cluster::Entry_1_0>;
        };
    };
                                                     ...
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    in_buffer.add_offset(8U);
        ...
        {
            uavcan::pnp::cluster::Entry_1_0 _tmp0_ = uavcan::pnp::cluster::Entry_1_0();
            {
            ...
            obj.entries.push_back(std::move(_tmp0_));
        }
    }
    in_buffer.align_offset_to<8U>();
