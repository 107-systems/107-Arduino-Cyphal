...
// Generated at:  2023-03-10 05:17:53.564772 UTC
// Is deprecated: no
// Fixed port-ID: 8174
...
#ifndef UAVCAN_INTERNET_UDP_OUTGOING_PACKET_0_2_HPP_INCLUDED
#define UAVCAN_INTERNET_UDP_OUTGOING_PACKET_0_2_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/internet/udp/8174.OutgoingPacket.0.2.dsdl "
...
///
struct OutgoingPacket_0_2 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t SerializationBufferSizeBytes = 561UL;
        ...
        struct TypeOf
        {
            ...
            using use_dtls = bool;
            using payload = nunavut::support::VariableLengthArray<std::uint8_t, 508>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const OutgoingPacket_0_2& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    const std::size_t capacity_bits = out_buffer.size();
    if ((static_cast<std::size_t>(capacity_bits)) < 4488UL)
    {
...
inline nunavut::support::SerializeResult deserialize(OutgoingPacket_0_2& obj,
...
#endif // UAVCAN_INTERNET_UDP_OUTGOING_PACKET_0_2_HPP_INCLUDED
