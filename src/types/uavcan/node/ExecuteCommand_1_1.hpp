...
// Generated at:  2024-03-22 12:34:31.318302 UTC
// Is deprecated: yes
// Fixed port-ID: 435
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/node/435.ExecuteCommand.1.1.dsdl "
...
///
[[deprecated("uavcan.node.ExecuteCommand.Request.1.1 is reaching the end of its life; there may be a newer version available")]]
struct Request_1_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        struct TypeOf
        {
            ...
            using parameter = nunavut::support::VariableLengthArray<std::uint8_t, 255>;
        };
    };
...
[[deprecated("uavcan.node.ExecuteCommand.Response.1.1 is reaching the end of its life; there may be a newer version available")]]
...
struct ExecuteCommand_1_1
{
    ExecuteCommand_1_1() = delete;

    using Request  = ExecuteCommand::Request_1_1;
    using Response = ExecuteCommand::Response_1_1;
...
#endif // UAVCAN_NODE_EXECUTE_COMMAND_1_1_HPP_INCLUDED
