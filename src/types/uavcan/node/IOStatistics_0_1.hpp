...
// Generated at:  2023-01-18 06:33:55.922645 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct IOStatistics_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =15UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =15UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // truncated uint40 num_emitted
            ...
            const auto _result3_ = out_buffer.setUxx(num_emitted, 40U);
            if(not _result3_){
        ...
        {   // truncated uint40 num_received
            NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
            NUNAVUT_ASSERT(40ULL <= out_buffer.size());
            const auto _result3_ = out_buffer.setUxx(num_received, 40U);
            if(not _result3_){
                return -_result3_.error();
            }
            out_buffer.add_offset(40U);
        ...
        {   // truncated uint40 num_errored
            NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
            NUNAVUT_ASSERT(40ULL <= out_buffer.size());
            const auto _result3_ = out_buffer.setUxx(num_errored, 40U);
            if(not _result3_){
                return -_result3_.error();
            }
            out_buffer.add_offset(40U);
        ...
        NUNAVUT_ASSERT(out_buffer.offset() == 120ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        num_emitted = in_buffer.getU64(40U);
        in_buffer.add_offset(40U);
        // truncated uint40 num_received
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        num_received = in_buffer.getU64(40U);
        in_buffer.add_offset(40U);
        // truncated uint40 num_errored
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        num_errored = in_buffer.getU64(40U);
        in_buffer.add_offset(40U);
