...
// Source file:   /tmp/public_regulated_data_types/uavcan/node/port/ServiceIDList.0.1.dsdl
// Generated at:  2023-01-24 05:52:10.995864 UTC
// Is deprecated: no
// Fixed port-ID: None
...
//     Uses std_variant:no
#ifndef UAVCAN_NODE_PORT_SERVICE_ID_LIST_0_1_HPP_INCLUDED
#define UAVCAN_NODE_PORT_SERVICE_ID_LIST_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/node/port/ServiceIDList.0.1.dsdl "
...
///
struct ServiceIDList_0_1 final
{
    // +---------------------------------------------------------------------------------------------------------------+
    // | PORT IDENTIFIERS
    // +---------------------------------------------------------------------------------------------------------------+
    ...
    static constexpr std::size_t EXTENT_BYTES                    =128UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated bool[512] mask
            NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
            NUNAVUT_ASSERT(512ULL <= out_buffer.size());
            const std::size_t _origin0_ = out_buffer.offset();
            for (size_t _index1_ = 0U; _index1_ < 512UL; ++_index1_)
            {
                NUNAVUT_ASSERT(1ULL <= out_buffer.size());
                auto _result2_ = out_buffer.setBit(mask[_index1_]);
                if(not _result2_){
            ...
            NUNAVUT_ASSERT((out_buffer.offset() - _origin0_) == 512ULL);
            (void) _origin0_;
        }
        {
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        for (size_t _index4_ = 0U; _index4_ < 512UL; ++_index4_)
        {
            mask[_index4_] = in_buffer.getBit();
...
#endif // UAVCAN_NODE_PORT_SERVICE_ID_LIST_0_1_HPP_INCLUDED
