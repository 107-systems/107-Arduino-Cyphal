...
// Generated at:  2023-01-29 16:46:55.674859 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct ID_1_0 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =3UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =3UL;
    ...
    class VariantType final
    {
        ...
        union internal_union_t
        {
            ...
            std::aligned_storage<sizeof(uavcan::node::port::SubjectID_1_0), alignof(uavcan::node::port::SubjectID_1_0)>::type subject_id;

            std::aligned_storage<sizeof(uavcan::node::port::ServiceID_1_0), alignof(uavcan::node::port::ServiceID_1_0)>::type service_id;
    ...
    public:
            ...
            , internal_union_value_()
        {
            ...
            {
                do_copy<0>(
                    *reinterpret_cast<std::add_pointer<const uavcan::node::port::SubjectID_1_0>::type>(&rhs.internal_union_value_.subject_id)
                );
            }
            else if(rhs.tag_ == 1)
            {
                do_copy<1>(
                    *reinterpret_cast<std::add_pointer<const uavcan::node::port::ServiceID_1_0>::type>(&rhs.internal_union_value_.service_id)
                );
            }
            tag_ = rhs.tag_;
        }
        ...
        {
            using type = uavcan::node::port::SubjectID_1_0;
            static constexpr auto pointer = &VariantType::internal_union_t::subject_id;
        };
        template<class...Types> struct alternative<1U, Types...>
        {
            using type = uavcan::node::port::ServiceID_1_0;
            static constexpr auto pointer = &VariantType::internal_union_t::service_id;
        };
    ...
    typename std::add_pointer<const uavcan::node::port::SubjectID_1_0>::type get_subject_id_if() const{
        return VariantType::get_if<VariantType::IndexOf::subject_id>(&union_value);
    }
    ...
    typename std::add_lvalue_reference<const uavcan::node::port::SubjectID_1_0>::type get_subject_id() const{
        NUNAVUT_ASSERT(is_subject_id());
        return *VariantType::get_if<VariantType::IndexOf::subject_id>(&union_value);
    }
    ...
    typename std::add_pointer<const uavcan::node::port::ServiceID_1_0>::type get_service_id_if() const{
        return VariantType::get_if<VariantType::IndexOf::service_id>(&union_value);
    }
    ...
    typename std::add_lvalue_reference<const uavcan::node::port::ServiceID_1_0>::type get_service_id() const{
        NUNAVUT_ASSERT(is_service_id());
        return *VariantType::get_if<VariantType::IndexOf::service_id>(&union_value);
    }
