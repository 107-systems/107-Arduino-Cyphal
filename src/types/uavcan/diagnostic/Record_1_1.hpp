...
// Generated at:  2023-01-18 06:06:50.331942 UTC
// Is deprecated: no
// Fixed port-ID: 8184
...
struct Record_1_1 final
{
    ...
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =264UL;
    ...
    ///
    nunavut::support::VariableLengthArray<std::uint8_t, 255> text;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        NUNAVUT_ASSERT(out_buffer.offset() <= 2112ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
