...
// Generated at:  2023-03-10 05:17:53.549146 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/time/SynchronizedTimestamp.1.0.dsdl "
...
///
struct SynchronizedTimestamp_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using microsecond = std::uint64_t;
        };
    };
    ...
    ///
    static constexpr std::uint64_t UNKNOWN = 0ULL;
    ...
    ///
    _traits_::TypeOf::microsecond microsecond{};
};

inline nunavut::support::SerializeResult serialize(const SynchronizedTimestamp_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // truncated uint56 microsecond
        const auto _result3_ = out_buffer.setUxx(obj.microsecond, 56U);
        if(not _result3_){
...
inline nunavut::support::SerializeResult deserialize(SynchronizedTimestamp_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    const auto capacity_bits = in_buffer.size();
    // truncated uint56 microsecond
    obj.microsecond = in_buffer.getU64(56U);
...
#endif // UAVCAN_TIME_SYNCHRONIZED_TIMESTAMP_1_0_HPP_INCLUDED
