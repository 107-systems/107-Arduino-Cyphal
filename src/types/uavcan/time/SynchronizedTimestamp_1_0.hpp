...
// Generated at:  2023-01-29 16:46:55.444179 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct SynchronizedTimestamp_1_0 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =7UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // truncated uint56 microsecond
            ...
            const auto _result3_ = out_buffer.setUxx(microsecond, 56U);
            if(not _result3_){
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        microsecond = in_buffer.getU64(56U);
