...
// Source file:   /tmp/public_regulated_data_types/uavcan/time/TimeSystem.0.1.dsdl
// Generated at:  2023-03-10 05:17:53.554381 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef UAVCAN_TIME_TIME_SYSTEM_0_1_HPP_INCLUDED
#define UAVCAN_TIME_TIME_SYSTEM_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/uavcan/time/TimeSystem.0.1.dsdl "
...
struct TimeSystem_0_1 final
{
    ...
    ///
    static constexpr std::uint8_t MONOTONIC_SINCE_BOOT = 0U;
    ///
    ...
    ///
    static constexpr std::uint8_t TAI = 1U;
    ///
    /// Application-specific time system of unknown properties.
    ///
    static constexpr std::uint8_t APPLICATION_SPECIFIC = 15U;
...
inline nunavut::support::SerializeResult serialize(const TimeSystem_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // truncated uint4 value
        const auto _result3_ = out_buffer.setUxx(obj.value, 4U);
        if(not _result3_){
            return -_result3_.error();
        }
        out_buffer.add_offset(4U);
    }
    {
...
inline nunavut::support::SerializeResult deserialize(TimeSystem_0_1& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    const auto capacity_bits = in_buffer.size();
    // truncated uint4 value
    obj.value = in_buffer.getU8(4U);
    in_buffer.add_offset(4U);
...
#endif // UAVCAN_TIME_TIME_SYSTEM_0_1_HPP_INCLUDED
