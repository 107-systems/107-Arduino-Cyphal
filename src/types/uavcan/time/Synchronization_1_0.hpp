...
struct Synchronization_1_0 final
{
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // truncated uint56 previous_transmission_timestamp_microsecond
            ...
            const auto _result3_ = out_buffer.setUxx(previous_transmission_timestamp_microsecond, 56U);
            if(not _result3_){
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        previous_transmission_timestamp_microsecond = in_buffer.getU64(56U);
