...
// Generated at:  2023-01-29 16:46:56.741832 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Heartbeat_0_1 final
{
    ...
    reg::udral::service::common::Readiness_0_1 readiness;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // reg.udral.service.common.Readiness.0.1 readiness
            ...
            auto _err0_ = readiness.serialize(_subspan0_.value());
            if (not _err0_)
            {
                return _err0_;
            }
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        {
            ...
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            {
                const auto _err1_ = readiness.deserialize(in_buffer.subspan());
                if(_err1_){
