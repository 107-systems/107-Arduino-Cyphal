...
// Source file:   /tmp/public_regulated_data_types/reg/udral/service/common/Heartbeat.0.1.dsdl
// Generated at:  2023-03-10 05:17:54.650309 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef REG_UDRAL_SERVICE_COMMON_HEARTBEAT_0_1_HPP_INCLUDED
#define REG_UDRAL_SERVICE_COMMON_HEARTBEAT_0_1_HPP_INCLUDED

#include <nunavut/support/serialization.hpp>
#include <types/reg/udral/service/common/Readiness_0_1.hpp>
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/reg/udral/service/common/Heartbeat.0.1.dsdl "
...
struct Heartbeat_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using readiness = reg::udral::service::common::Readiness_0_1;
    ...
    _traits_::TypeOf::readiness readiness;

    _traits_::TypeOf::health health;
};

inline nunavut::support::SerializeResult serialize(const Heartbeat_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // reg.udral.service.common.Readiness.0.1 readiness
        ...
        auto _err0_ = serialize(obj.readiness, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
...
inline nunavut::support::SerializeResult deserialize(Heartbeat_0_1& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // reg.udral.service.common.Readiness.0.1 readiness
    {
        ...
        {
            const auto _err1_ = deserialize(obj.readiness, in_buffer.subspan());
            if(_err1_){
...
#endif // REG_UDRAL_SERVICE_COMMON_HEARTBEAT_0_1_HPP_INCLUDED
