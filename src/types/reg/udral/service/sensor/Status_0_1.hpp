...
// Generated at:  2023-03-10 05:17:54.720209 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#include <types/uavcan/si/unit/duration/Scalar_1_0.hpp>
...
struct Status_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using data_validity_period = uavcan::si::unit::duration::Scalar_1_0;
            using error_count = std::uint32_t;
            using sensor_temperature = uavcan::si::unit::temperature::Scalar_1_0;
        };
    };
    ...
    ///
    _traits_::TypeOf::data_validity_period data_validity_period;
    ///
    ...
    ///
    _traits_::TypeOf::sensor_temperature sensor_temperature;
};
                                                   ...
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // uavcan.si.unit.duration.Scalar.1.0 data_validity_period
        ...
        auto _err0_ = serialize(obj.data_validity_period, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
    ...
    {   // uavcan.si.unit.temperature.Scalar.1.0 sensor_temperature
        ...
        auto _err0_ = serialize(obj.sensor_temperature, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
                                                     ...
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // uavcan.si.unit.duration.Scalar.1.0 data_validity_period
    {
        ...
        {
            const auto _err1_ = deserialize(obj.data_validity_period, in_buffer.subspan());
            if(_err1_){
    ...
    // uavcan.si.unit.temperature.Scalar.1.0 sensor_temperature
    {
        std::size_t _size_bytes1_ = in_buffer.size() / 8U;
        {
            const auto _err1_ = deserialize(obj.sensor_temperature, in_buffer.subspan());
            if(_err1_){
                _size_bytes1_ = _err1_.value();
            }else{
                return -_err1_.error();
