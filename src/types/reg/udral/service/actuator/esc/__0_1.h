...
// Generated at:  2022-12-15 22:24:32.626033 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/public_regulated_data_types/reg/udral/service/actuator/esc/_.0.1.dsdl is trying to use a serialization library that was compiled with "
...
static inline int8_t reg_udral_service_actuator_esc___0_1_deserialize_(
    reg_udral_service_actuator_esc___0_1* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
