...
// Generated at:  2023-01-18 06:06:51.730547 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/reg/udral/service/actuator/common/Feedback.0.1.dsdl "
...
struct Feedback_0_1 final
{
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated int8 demand_factor_pct
            ...
            const auto _result3_ = out_buffer.setIxx(demand_factor_pct, 8U);
            if(not _result3_){
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        // saturated int8 demand_factor_pct
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        demand_factor_pct = in_buffer.getI8(8U);
...
#endif // REG_UDRAL_SERVICE_ACTUATOR_COMMON_FEEDBACK_0_1_HPP_INCLUDED
