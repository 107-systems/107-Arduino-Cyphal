...
// Generated at:  2023-01-29 16:46:56.777195 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Vector31_0_1 final
{
    ...
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =62UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // saturated float16[31] value
            NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
            NUNAVUT_ASSERT(496ULL <= out_buffer.size());
            ...
            NUNAVUT_ASSERT((out_buffer.offset() - _origin0_) == 496ULL);
            (void) _origin0_;
        }
        {
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() == 496ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        for (size_t _index4_ = 0U; _index4_ < 31UL; ++_index4_)
        {
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
