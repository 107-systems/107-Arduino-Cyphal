...
// Generated at:  2024-03-22 13:17:27.601676 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#define REG_UDRAL_PHYSICS_ACOUSTICS_NOTE_0_1_HPP_INCLUDED

#include <nunavut/support/serialization.hpp>
#include <types/uavcan/si/unit/duration/Scalar_1_0.hpp>
#include <types/uavcan/si/unit/frequency/Scalar_1_0.hpp>
#include <types/uavcan/si/unit/power/Scalar_1_0.hpp>
#include <limits>
...
struct Note_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using frequency = uavcan::si::unit::frequency::Scalar_1_0;
            using duration = uavcan::si::unit::duration::Scalar_1_0;
            using acoustic_power = uavcan::si::unit::power::Scalar_1_0;
        };
    };
                                                   ...
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // uavcan.si.unit.frequency.Scalar.1.0 frequency
        ...
        auto _err0_ = serialize(obj.frequency, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
    ...
    {   // uavcan.si.unit.duration.Scalar.1.0 duration
        ...
        auto _err0_ = serialize(obj.duration, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
    ...
    {   // uavcan.si.unit.power.Scalar.1.0 acoustic_power
        ...
        auto _err0_ = serialize(obj.acoustic_power, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
...
inline nunavut::support::SerializeResult deserialize(Note_0_1& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // uavcan.si.unit.frequency.Scalar.1.0 frequency
    {
        ...
        {
            const auto _err1_ = deserialize(obj.frequency, in_buffer.subspan());
            if(_err1_){
    ...
    // uavcan.si.unit.duration.Scalar.1.0 duration
    {
        std::size_t _size_bytes1_ = in_buffer.size() / 8U;
        {
            const auto _err1_ = deserialize(obj.duration, in_buffer.subspan());
            if(_err1_){
                _size_bytes1_ = _err1_.value();
            }else{
                return -_err1_.error();
    ...
    // uavcan.si.unit.power.Scalar.1.0 acoustic_power
    {
        std::size_t _size_bytes1_ = in_buffer.size() / 8U;
        {
            const auto _err1_ = deserialize(obj.acoustic_power, in_buffer.subspan());
            if(_err1_){
                _size_bytes1_ = _err1_.value();
            }else{
                return -_err1_.error();
...
#endif // REG_UDRAL_PHYSICS_ACOUSTICS_NOTE_0_1_HPP_INCLUDED
