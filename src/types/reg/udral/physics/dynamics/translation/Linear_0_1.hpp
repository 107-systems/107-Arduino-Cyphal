...
// Generated at:  2023-01-24 05:52:12.359982 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Linear_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =16UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =16UL;
    ...
    reg::udral::physics::kinematics::translation::Linear_0_1 kinematics;
    ///
    /// NaN if unknown
    ///
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // reg.udral.physics.kinematics.translation.Linear.0.1 kinematics
            ...
            auto _err0_ = kinematics.serialize(_subspan0_.value());
            if (not _err0_)
            {
                return _err0_;
            }
        ...
        {   // uavcan.si.unit.force.Scalar.1.0 force
            ...
            NUNAVUT_ASSERT(_subspan0_->offset_alings_to_byte());
            auto _err0_ = force.serialize(_subspan0_.value());
            if (not _err0_)
            {
                return _err0_;
            }
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        {
            ...
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            {
                const auto _err1_ = kinematics.deserialize(in_buffer.subspan());
                if(_err1_){
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        {
            ...
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            {
                const auto _err1_ = force.deserialize(in_buffer.subspan());
                if(_err1_){
                    _size_bytes1_ = _err1_.value();
                }else{
                    return -_err1_.error();
