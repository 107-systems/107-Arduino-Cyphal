...
// Generated at:  2023-01-29 16:46:56.606668 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct LinearTs_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =23UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =23UL;
    ...
    reg::udral::physics::dynamics::translation::Linear_0_1 value;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() == 184ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
