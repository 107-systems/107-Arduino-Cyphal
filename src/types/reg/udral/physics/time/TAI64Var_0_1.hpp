...
// Generated at:  2023-03-10 05:17:54.544156 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/reg/udral/physics/time/TAI64Var.0.1.dsdl "
...
struct TAI64Var_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using value = reg::udral::physics::time::TAI64_0_1;
...
#endif // REG_UDRAL_PHYSICS_TIME_TAI64VAR_0_1_HPP_INCLUDED
