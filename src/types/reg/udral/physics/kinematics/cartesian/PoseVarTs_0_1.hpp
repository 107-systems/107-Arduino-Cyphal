...
// Generated at:  2023-01-24 05:52:12.281305 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct PoseVarTs_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =89UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =89UL;
    ...
    reg::udral::physics::kinematics::cartesian::PoseVar_0_1 value;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() == 712ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
