...
// Generated at:  2023-01-18 06:33:57.095473 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct TwistVarTs_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =73UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =73UL;
    ...
    reg::udral::physics::kinematics::cartesian::TwistVar_0_1 value;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() == 584ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
