...
// Generated at:  2023-01-29 16:46:56.665019 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct TwistVar_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =66UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =66UL;
    ...
    reg::udral::physics::kinematics::cartesian::Twist_0_1 value;
    ///
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() == 528ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
