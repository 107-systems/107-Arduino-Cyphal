...
// Generated at:  2023-01-24 05:52:12.293965 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Twist_0_1 final
{
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // uavcan.si.unit.velocity.Vector3.1.0 linear
            ...
            auto _err0_ = linear.serialize(_subspan0_.value());
            if (not _err0_)
            {
                return _err0_;
            }
        ...
        {   // uavcan.si.unit.angular_velocity.Vector3.1.0 angular
            ...
            NUNAVUT_ASSERT(_subspan0_->offset_alings_to_byte());
            auto _err0_ = angular.serialize(_subspan0_.value());
            if (not _err0_)
            {
                return _err0_;
            }
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        {
            ...
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            {
                const auto _err1_ = linear.deserialize(in_buffer.subspan());
                if(_err1_){
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        {
            ...
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            {
                const auto _err1_ = angular.deserialize(in_buffer.subspan());
                if(_err1_){
                    _size_bytes1_ = _err1_.value();
                }else{
                    return -_err1_.error();
