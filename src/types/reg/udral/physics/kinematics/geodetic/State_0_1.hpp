...
// Generated at:  2023-01-29 16:46:56.716571 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct State_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =64UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =64UL;
    ...
    reg::udral::physics::kinematics::geodetic::Pose_0_1 pose;

    reg::udral::physics::kinematics::cartesian::Twist_0_1 twist;
