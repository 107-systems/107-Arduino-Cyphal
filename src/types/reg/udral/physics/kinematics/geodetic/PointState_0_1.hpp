...
// Generated at:  2023-01-18 06:06:51.632170 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct PointState_0_1 final
{
    ...
    static constexpr std::size_t EXTENT_BYTES                    =36UL;
    static constexpr std::size_t SERIALIZATION_BUFFER_SIZE_BYTES =36UL;
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        // It is assumed that we know the exact type of the serialized entity, hence we expect the size to match.
        NUNAVUT_ASSERT(out_buffer.offset() == 288ULL);
        NUNAVUT_ASSERT(out_buffer.offset_alings_to_byte());
