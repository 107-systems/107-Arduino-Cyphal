...
// Generated at:  2023-03-10 05:17:54.549262 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/reg/udral/physics/kinematics/translation/Linear.0.1.dsdl "
...
struct Linear_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using position = uavcan::si::unit::length::Scalar_1_0;
            using velocity = uavcan::si::unit::velocity::Scalar_1_0;
            using acceleration = uavcan::si::unit::acceleration::Scalar_1_0;
        };
    };
                                                   ...
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // uavcan.si.unit.acceleration.Scalar.1.0 acceleration
        ...
        auto _err0_ = serialize(obj.acceleration, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
                                                     ...
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // uavcan.si.unit.acceleration.Scalar.1.0 acceleration
    {
        std::size_t _size_bytes1_ = in_buffer.size() / 8U;
        {
            const auto _err1_ = deserialize(obj.acceleration, in_buffer.subspan());
            if(_err1_){
                _size_bytes1_ = _err1_.value();
            }else{
                return -_err1_.error();
...
#endif // REG_UDRAL_PHYSICS_KINEMATICS_TRANSLATION_LINEAR_0_1_HPP_INCLUDED
