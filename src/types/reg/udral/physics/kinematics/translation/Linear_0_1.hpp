...
// Generated at:  2023-01-18 06:06:51.562149 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Linear_0_1 final
{
    ...
    serialize(nunavut::support::bitspan out_buffer) const
    {
        ...
        {   // uavcan.si.unit.acceleration.Scalar.1.0 acceleration
            ...
            NUNAVUT_ASSERT(_subspan0_->offset_alings_to_byte());
            auto _err0_ = acceleration.serialize(_subspan0_.value());
            if (not _err0_)
            {
                return _err0_;
            }
    ...
    deserialize(nunavut::support::const_bitspan in_buffer)
    {
        ...
        NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
        {
            ...
            NUNAVUT_ASSERT(in_buffer.offset_alings_to_byte());
            {
                const auto _err1_ = acceleration.deserialize(in_buffer.subspan());
                if(_err1_){
                    _size_bytes1_ = _err1_.value();
                }else{
                    return -_err1_.error();
