...
// Source file:   /tmp/public_regulated_data_types/reg/udral/physics/kinematics/translation/Velocity3Var.0.1.dsdl
// Generated at:  2024-01-29 05:34:31.755427 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
#ifndef REG_UDRAL_PHYSICS_KINEMATICS_TRANSLATION_VELOCITY3VAR_0_1_HPP_INCLUDED
#define REG_UDRAL_PHYSICS_KINEMATICS_TRANSLATION_VELOCITY3VAR_0_1_HPP_INCLUDED

#include <nunavut/support/serialization.hpp>
#include <types/uavcan/si/sample/velocity/Vector3_1_0.hpp>
#include <array>
#include <limits>
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/public_regulated_data_types/reg/udral/physics/kinematics/translation/Velocity3Var.0.1.dsdl "
...
///
struct [[deprecated("reg.udral.physics.kinematics.translation.Velocity3Var.0.1 is reaching the end of its life; there may be a newer version available")]]Velocity3Var_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 31UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 31UL;
        ...
        {
            TypeOf() = delete;
            using value = uavcan::si::sample::velocity::Vector3_1_0;
...
inline nunavut::support::SerializeResult serialize(const Velocity3Var_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    const std::size_t capacity_bits = out_buffer.size();
    if ((static_cast<std::size_t>(capacity_bits)) < 248UL)
    {
...
inline nunavut::support::SerializeResult deserialize(Velocity3Var_0_1& obj,
...
#endif // REG_UDRAL_PHYSICS_KINEMATICS_TRANSLATION_VELOCITY3VAR_0_1_HPP_INCLUDED
