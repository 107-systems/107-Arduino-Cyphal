...
// Generated at:  2023-03-10 05:17:54.558520 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Velocity1VarTs_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using value = uavcan::si::sample::velocity::Scalar_1_0;
...
inline nunavut::support::SerializeResult serialize(const Velocity1VarTs_0_1& obj,
...
inline nunavut::support::SerializeResult deserialize(Velocity1VarTs_0_1& obj,
