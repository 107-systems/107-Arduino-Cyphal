...
// Source file:   /tmp/public_regulated_data_types/reg/drone/service/battery/Parameters.0.3.uavcan
// Generated at:  2021-09-27 06:53:05.711301 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/public_regulated_data_types/reg/drone/service/battery/Parameters.0.3.uavcan is trying to use a serialization library that was compiled with "
    ...
    const reg_drone_service_battery_Parameters_0_3* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    if (offset_bits % 8U != 0U)  // Pad to 8 bits. TODO: Eliminate redundant padding checks.
    {
        ...
        const int8_t _err25_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, 0U, _pad11_);  // Optimize?
        if (_err25_ < 0)
        {
            return _err25_;
        }
    ...
    NUNAVUT_ASSERT(offset_bits == 464ULL);
    ...
    reg_drone_service_battery_Parameters_0_3* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err26_ = uavcan_si_unit_mass_Scalar_1_0_deserialize_(
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err27_ = uavcan_si_unit_electric_charge_Scalar_1_0_deserialize_(
