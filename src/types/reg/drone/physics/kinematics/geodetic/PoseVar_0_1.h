...
// Source file:   /tmp/public_regulated_data_types/reg/drone/physics/kinematics/geodetic/PoseVar.0.1.uavcan
// Generated at:  2021-09-27 06:53:05.532542 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/public_regulated_data_types/reg/drone/physics/kinematics/geodetic/PoseVar.0.1.uavcan is trying to use a serialization library that was compiled with "
    ...
    reg_drone_physics_kinematics_geodetic_PoseVar_0_1* const out_obj, const uint8_t* const buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    NUNAVUT_ASSERT(offset_bits % 8U == 0U);
    {
        ...
        NUNAVUT_ASSERT(offset_bits % 8U == 0U);
        const int8_t _err3_ = reg_drone_physics_kinematics_geodetic_Pose_0_1_deserialize_(
