...
// Source file:   /tmp/zubax_dsdl/zubax/bridge/can/PhysicalConfig.1.0.dsdl
// Generated at:  2024-03-22 12:34:33.183539 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_BRIDGE_CAN_PHYSICAL_CONFIG_1_0_HPP_INCLUDED
#define ZUBAX_BRIDGE_CAN_PHYSICAL_CONFIG_1_0_HPP_INCLUDED

#include <nunavut/support/serialization.hpp>
#include <types/zubax/bridge/can/TimingConfig_1_0.hpp>
#include <cstdint>
#include <limits>
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/bridge/can/PhysicalConfig.1.0.dsdl "
...
///
struct PhysicalConfig_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 256UL;
        ...
        struct TypeOf
        {
            ...
            using timing = zubax::bridge::can::TimingConfig_1_0;
            using timing_fd = zubax::bridge::can::TimingConfig_1_0;
        };
    };
    ...
    ///
    static constexpr std::uint8_t MODE_IDLE = 0U;
    ///
    ...
    /// The mode value 2 is reserved for future use. If such value is encountered, the behavior is implementation-
    /// defined.
    ///
    static constexpr std::uint8_t MODE_SILENT = 1U;
    ///
    /// In the normal mode, the bridge will perform regular bidirectional forwarding.
    ///
    static constexpr std::uint8_t MODE_NORMAL = 3U;
    ...
    ///
    _traits_::TypeOf::timing_fd timing_fd;
};

inline nunavut::support::SerializeResult serialize(const PhysicalConfig_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // zubax.bridge.can.TimingConfig.1.0 timing
        ...
        auto _err0_ = serialize(obj.timing, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
    ...
    {   // zubax.bridge.can.TimingConfig.1.0 timing_fd
        ...
        auto _err0_ = serialize(obj.timing_fd, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
...
inline nunavut::support::SerializeResult deserialize(PhysicalConfig_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    const auto capacity_bits = in_buffer.size();
    // saturated uint2 mode
    obj.mode = in_buffer.getU8(2U);
    ...
    // zubax.bridge.can.TimingConfig.1.0 timing
    {
        ...
        {
            const auto _err1_ = deserialize(obj.timing, in_buffer.subspan());
            if(_err1_){
    ...
    // zubax.bridge.can.TimingConfig.1.0 timing_fd
    {
        std::size_t _size_bytes1_ = in_buffer.size() / 8U;
        {
            const auto _err1_ = deserialize(obj.timing_fd, in_buffer.subspan());
            if(_err1_){
                _size_bytes1_ = _err1_.value();
            }else{
                return -_err1_.error();
...
#endif // ZUBAX_BRIDGE_CAN_PHYSICAL_CONFIG_1_0_HPP_INCLUDED
