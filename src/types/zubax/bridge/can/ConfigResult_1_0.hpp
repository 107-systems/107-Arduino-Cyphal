...
// Source file:   /tmp/zubax_dsdl/zubax/bridge/can/ConfigResult.1.0.dsdl
// Generated at:  2024-03-22 12:34:33.155276 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_BRIDGE_CAN_CONFIG_RESULT_1_0_HPP_INCLUDED
#define ZUBAX_BRIDGE_CAN_CONFIG_RESULT_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/bridge/can/ConfigResult.1.0.dsdl "
...
struct ConfigResult_1_0 final
{
    ...
    ///
    static constexpr std::uint8_t SUCCESS = 0U;
    ///
    ...
    ///
    static constexpr std::uint8_t UNSUPPORTED_BIT_RATE = 1U;
    ///
    ...
    ///
    static constexpr std::uint8_t INITIALIZATION_TIMED_OUT = 2U;
    ///
    /// Any other error not listed here.
    ///
    static constexpr std::uint8_t OTHER_ERROR = 255U;
...
inline nunavut::support::SerializeResult serialize(const ConfigResult_1_0& obj,
...
inline nunavut::support::SerializeResult deserialize(ConfigResult_1_0& obj,
...
#endif // ZUBAX_BRIDGE_CAN_CONFIG_RESULT_1_0_HPP_INCLUDED
