...
// Source file:   /tmp/zubax_dsdl/zubax/bridge/can/BusErrorCounters.1.0.dsdl
// Generated at:  2024-03-22 13:17:28.592310 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_BRIDGE_CAN_BUS_ERROR_COUNTERS_1_0_HPP_INCLUDED
#define ZUBAX_BRIDGE_CAN_BUS_ERROR_COUNTERS_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/bridge/can/BusErrorCounters.1.0.dsdl "
...
///
struct BusErrorCounters_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using form = std::uint64_t;
            using ack = std::uint64_t;
            using bit_dominant = std::uint64_t;
            using bit_recessive = std::uint64_t;
    ...
    ///
    _traits_::TypeOf::bit_recessive bit_recessive{};
    ///
    /// The CRC value of a received frame did not match.
    ///
    _traits_::TypeOf::crc crc{};
};

inline nunavut::support::SerializeResult serialize(const BusErrorCounters_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated uint48 bit_dominant
        std::uint64_t _sat0_ = obj.bit_dominant;
        if (_sat0_ > 281474976710655ULL)
        {
            _sat0_ = 281474976710655ULL;
        }
    ...
    {   // saturated uint48 bit_recessive
        std::uint64_t _sat0_ = obj.bit_recessive;
        if (_sat0_ > 281474976710655ULL)
        {
            _sat0_ = 281474976710655ULL;
        }
...
inline nunavut::support::SerializeResult deserialize(BusErrorCounters_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    const auto capacity_bits = in_buffer.size();
    // saturated uint48 form
    obj.form = in_buffer.getU64(48U);
    in_buffer.add_offset(48U);
    // saturated uint48 ack
    obj.ack = in_buffer.getU64(48U);
    in_buffer.add_offset(48U);
    // saturated uint48 bit_dominant
    obj.bit_dominant = in_buffer.getU64(48U);
    in_buffer.add_offset(48U);
    // saturated uint48 bit_recessive
    obj.bit_recessive = in_buffer.getU64(48U);
    in_buffer.add_offset(48U);
    // saturated uint48 crc
    obj.crc = in_buffer.getU64(48U);
    in_buffer.add_offset(48U);
    // void48
...
#endif // ZUBAX_BRIDGE_CAN_BUS_ERROR_COUNTERS_1_0_HPP_INCLUDED
