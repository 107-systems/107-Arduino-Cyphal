...
// Source file:   /tmp/zubax_dsdl/zubax/bridge/can/TimingConfig.1.0.dsdl
// Generated at:  2024-03-22 13:17:28.640715 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_BRIDGE_CAN_TIMING_CONFIG_1_0_HPP_INCLUDED
#define ZUBAX_BRIDGE_CAN_TIMING_CONFIG_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/bridge/can/TimingConfig.1.0.dsdl "
...
struct TimingConfig_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 4UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 4UL;
        ...
        {
            TypeOf() = delete;
            using bit_rate = std::uint32_t;
            using sample_point_location_percent = std::uint8_t;
        };
    };
    ...
    ///
    static constexpr std::uint8_t SAMPLE_POINT_LOCATION_NOMINAL_PERCENT_UAVCAN = 85U;
    ...
    /// In bits per second.
    ///
    _traits_::TypeOf::bit_rate bit_rate{};
    ///
    ...
    ///
    _traits_::TypeOf::sample_point_location_percent sample_point_location_percent{};
};

inline nunavut::support::SerializeResult serialize(const TimingConfig_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    const std::size_t capacity_bits = out_buffer.size();
    if ((static_cast<std::size_t>(capacity_bits)) < 32UL)
    {
    ...
    {   // saturated uint24 bit_rate
        std::uint32_t _sat0_ = obj.bit_rate;
    ...
    {   // saturated uint7 sample_point_location_percent
        std::uint8_t _sat0_ = obj.sample_point_location_percent;
        if (_sat0_ > 127U)
        {
            _sat0_ = 127U;
        }
...
inline nunavut::support::SerializeResult deserialize(TimingConfig_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    const auto capacity_bits = in_buffer.size();
    // saturated uint24 bit_rate
    obj.bit_rate = in_buffer.getU32(24U);
    in_buffer.add_offset(24U);
    // saturated uint7 sample_point_location_percent
    obj.sample_point_location_percent = in_buffer.getU8(7U);
...
#endif // ZUBAX_BRIDGE_CAN_TIMING_CONFIG_1_0_HPP_INCLUDED
