...
// Generated at:  2024-03-22 12:34:33.157663 UTC
// Is deprecated: no
// Fixed port-ID: None
...
struct Configuration_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        struct TypeOf
        {
            ...
            using filter_config = nunavut::support::VariableLengthArray<zubax::bridge::can::FilterConfig_1_0, 32>;
        };
    };
                                                     ...
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    in_buffer.add_offset(8U);
        ...
        for (std::size_t _index5_ = 0U; _index5_ < _size0_; ++_index5_)
        {
            ...
            obj.filter_config.push_back();
            {
            std::size_t _size_bytes1_ = in_buffer.size() / 8U;
            {
                const auto _err1_ = deserialize(obj.filter_config[_index5_], in_buffer.subspan());
                if(_err1_){
                    _size_bytes1_ = _err1_.value();
                }else{
                    return -_err1_.error();
