...
// Source file:   /tmp/zubax_dsdl/zubax/physics/electricity/Power.0.1.dsdl
// Generated at:  2024-03-22 13:17:28.900503 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
#ifndef ZUBAX_PHYSICS_ELECTRICITY_POWER_0_1_HPP_INCLUDED
#define ZUBAX_PHYSICS_ELECTRICITY_POWER_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/physics/electricity/Power.0.1.dsdl "
...
// +-------------------------------------------------------------------------------------------------------------------+
///
/// DC or AC RMS line electric power quantities. Generally, the following current sign convention applies:
///
...
///
struct [[deprecated("zubax.physics.electricity.Power.0.1 is reaching the end of its life; there may be a newer version available")]]Power_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 8UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 8UL;
        ...
        {
            TypeOf() = delete;
            using current = uavcan::si::unit::electric_current::Scalar_1_0;
            using voltage = uavcan::si::unit::voltage::Scalar_1_0;
        };
    };
    ...
    _traits_::TypeOf::current current{};

    _traits_::TypeOf::voltage voltage{};
};

inline nunavut::support::SerializeResult serialize(const Power_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // uavcan.si.unit.electric_current.Scalar.1.0 current
        ...
        auto _err0_ = serialize(obj.current, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
    ...
    {   // uavcan.si.unit.voltage.Scalar.1.0 voltage
        ...
        auto _err0_ = serialize(obj.voltage, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
...
inline nunavut::support::SerializeResult deserialize(Power_0_1& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // uavcan.si.unit.electric_current.Scalar.1.0 current
    {
        ...
        {
            const auto _err1_ = deserialize(obj.current, in_buffer.subspan());
            if(_err1_){
    ...
    // uavcan.si.unit.voltage.Scalar.1.0 voltage
    {
        std::size_t _size_bytes1_ = in_buffer.size() / 8U;
        {
            const auto _err1_ = deserialize(obj.voltage, in_buffer.subspan());
            if(_err1_){
                _size_bytes1_ = _err1_.value();
            }else{
                return -_err1_.error();
...
#endif // ZUBAX_PHYSICS_ELECTRICITY_POWER_0_1_HPP_INCLUDED
