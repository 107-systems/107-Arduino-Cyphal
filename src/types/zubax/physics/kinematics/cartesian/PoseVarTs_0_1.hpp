...
// Source file:   /tmp/zubax_dsdl/zubax/physics/kinematics/cartesian/PoseVarTs.0.1.dsdl
// Generated at:  2024-03-22 13:17:28.876914 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_PHYSICS_KINEMATICS_CARTESIAN_POSE_VAR_TS_0_1_HPP_INCLUDED
#define ZUBAX_PHYSICS_KINEMATICS_CARTESIAN_POSE_VAR_TS_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/physics/kinematics/cartesian/PoseVarTs.0.1.dsdl "
...
struct PoseVarTs_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 89UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 89UL;
        ...
        struct TypeOf
        {
            ...
            using value = zubax::physics::kinematics::cartesian::PoseVar_0_1;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const PoseVarTs_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    const std::size_t capacity_bits = out_buffer.size();
    if ((static_cast<std::size_t>(capacity_bits)) < 712UL)
    {
...
inline nunavut::support::SerializeResult deserialize(PoseVarTs_0_1& obj,
...
#endif // ZUBAX_PHYSICS_KINEMATICS_CARTESIAN_POSE_VAR_TS_0_1_HPP_INCLUDED
