...
// Source file:   /tmp/zubax_dsdl/zubax/physics/kinematics/cartesian/TwistVar.0.1.dsdl
// Generated at:  2024-03-22 13:17:28.891507 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_PHYSICS_KINEMATICS_CARTESIAN_TWIST_VAR_0_1_HPP_INCLUDED
#define ZUBAX_PHYSICS_KINEMATICS_CARTESIAN_TWIST_VAR_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/physics/kinematics/cartesian/TwistVar.0.1.dsdl "
...
struct TwistVar_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 66UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 66UL;
        ...
        {
            TypeOf() = delete;
            using value = zubax::physics::kinematics::cartesian::Twist_0_1;
            using covariance_urt = std::array<float,21>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const TwistVar_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    const std::size_t capacity_bits = out_buffer.size();
    if ((static_cast<std::size_t>(capacity_bits)) < 528UL)
    {
    ...
    {   // saturated float16[21] covariance_urt
        ...
        for (std::size_t _index1_ = 0U; _index1_ < 21UL; ++_index1_)
        {
...
inline nunavut::support::SerializeResult deserialize(TwistVar_0_1& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // saturated float16[21] covariance_urt
    for (std::size_t _index4_ = 0U; _index4_ < 21UL; ++_index4_)
    {
...
#endif // ZUBAX_PHYSICS_KINEMATICS_CARTESIAN_TWIST_VAR_0_1_HPP_INCLUDED
