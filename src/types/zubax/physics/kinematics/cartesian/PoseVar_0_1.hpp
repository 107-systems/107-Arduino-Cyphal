...
// Source file:   /tmp/zubax_dsdl/zubax/physics/kinematics/cartesian/PoseVar.0.1.dsdl
// Generated at:  2024-03-22 12:34:33.357595 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_PHYSICS_KINEMATICS_CARTESIAN_POSE_VAR_0_1_HPP_INCLUDED
#define ZUBAX_PHYSICS_KINEMATICS_CARTESIAN_POSE_VAR_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/physics/kinematics/cartesian/PoseVar.0.1.dsdl "
...
struct PoseVar_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 82UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 82UL;
        static_assert(ExtentBytes >= SerializationBufferSizeBytes, "Internal constraint violation");
        static_assert(ExtentBytes < (std::numeric_limits<std::size_t>::max() / 8U), "This message is too large to be handled by the selected types");
        struct TypeOf
        {
            TypeOf() = delete;
            using value = zubax::physics::kinematics::cartesian::Pose_0_1;
...
inline nunavut::support::SerializeResult serialize(const PoseVar_0_1& obj,
...
inline nunavut::support::SerializeResult deserialize(PoseVar_0_1& obj,
...
#endif // ZUBAX_PHYSICS_KINEMATICS_CARTESIAN_POSE_VAR_0_1_HPP_INCLUDED
