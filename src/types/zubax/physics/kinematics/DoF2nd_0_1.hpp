...
// Source file:   /tmp/zubax_dsdl/zubax/physics/kinematics/DoF2nd.0.1.dsdl
// Generated at:  2024-03-22 13:17:28.797706 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
#ifndef ZUBAX_PHYSICS_KINEMATICS_DO_F2ND_0_1_HPP_INCLUDED
#define ZUBAX_PHYSICS_KINEMATICS_DO_F2ND_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/physics/kinematics/DoF2nd.0.1.dsdl "
...
///
struct [[deprecated("zubax.physics.kinematics.DoF2nd.0.1 is reaching the end of its life; there may be a newer version available")]]DoF2nd_0_1 final
{
                                                   ...
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated float32 position
        ...
        auto _result4_ = out_buffer.setF32(obj.position);
        if(not _result4_){
    ...
    {   // saturated float32 velocity
        // Saturation code not emitted -- assume the native representation of float32 is conformant.
        static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
        auto _result4_ = out_buffer.setF32(obj.velocity);
        if(not _result4_){
            return -_result4_.error();
        }
        out_buffer.add_offset(32U);
                                                     ...
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // saturated float32 position
    obj.position = in_buffer.getF32();
    in_buffer.add_offset(32U);
    // saturated float32 velocity
    obj.velocity = in_buffer.getF32();
    in_buffer.add_offset(32U);
...
#endif // ZUBAX_PHYSICS_KINEMATICS_DO_F2ND_0_1_HPP_INCLUDED
