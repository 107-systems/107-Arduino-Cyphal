...
// Source file:   /tmp/zubax_dsdl/zubax/physics/kinematics/geodetic/Point.0.1.dsdl
// Generated at:  2024-03-22 13:17:28.826712 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_PHYSICS_KINEMATICS_GEODETIC_POINT_0_1_HPP_INCLUDED
#define ZUBAX_PHYSICS_KINEMATICS_GEODETIC_POINT_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/physics/kinematics/geodetic/Point.0.1.dsdl "
...
struct Point_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        struct TypeOf
        {
            ...
            using altitude = uavcan::si::unit::length::WideScalar_1_0;
        };
    };
    ...
    /// [radian]
    ///
    _traits_::TypeOf::latitude latitude{};
    ///
    /// [radian]
    ///
    _traits_::TypeOf::longitude longitude{};
    ///
    /// Distance between the local mean sea level (MSL) and the focal point of the antenna. Positive altitude above the
    /// MSL.
    ///
    _traits_::TypeOf::altitude altitude{};
};

inline nunavut::support::SerializeResult serialize(const Point_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated float64 latitude
        ...
        auto _result4_ = out_buffer.setF64(obj.latitude);
        if(not _result4_){
    ...
    {   // saturated float64 longitude
        // Saturation code not emitted -- assume the native representation of float64 is conformant.
        static_assert(NUNAVUT_PLATFORM_IEEE754_DOUBLE, "Native IEEE754 binary64 required. TODO: relax constraint");
        auto _result4_ = out_buffer.setF64(obj.longitude);
        if(not _result4_){
            return -_result4_.error();
        }
        out_buffer.add_offset(64U);
    ...
    {   // uavcan.si.unit.length.WideScalar.1.0 altitude
        ...
        auto _err0_ = serialize(obj.altitude, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
...
inline nunavut::support::SerializeResult deserialize(Point_0_1& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    const auto capacity_bits = in_buffer.size();
    // saturated float64 latitude
    obj.latitude = in_buffer.getF64();
    in_buffer.add_offset(64U);
    // saturated float64 longitude
    obj.longitude = in_buffer.getF64();
    in_buffer.add_offset(64U);
    ...
    // uavcan.si.unit.length.WideScalar.1.0 altitude
    {
        ...
        {
            const auto _err1_ = deserialize(obj.altitude, in_buffer.subspan());
            if(_err1_){
...
#endif // ZUBAX_PHYSICS_KINEMATICS_GEODETIC_POINT_0_1_HPP_INCLUDED
