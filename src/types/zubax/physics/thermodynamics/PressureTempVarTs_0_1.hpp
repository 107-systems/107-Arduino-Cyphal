...
// Source file:   /tmp/zubax_dsdl/zubax/physics/thermodynamics/PressureTempVarTs.0.1.dsdl
// Generated at:  2024-01-29 05:34:32.874524 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_PHYSICS_THERMODYNAMICS_PRESSURE_TEMP_VAR_TS_0_1_HPP_INCLUDED
#define ZUBAX_PHYSICS_THERMODYNAMICS_PRESSURE_TEMP_VAR_TS_0_1_HPP_INCLUDED

#include <nunavut/support/serialization.hpp>
#include <types/uavcan/si/unit/pressure/Scalar_1_0.hpp>
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/physics/thermodynamics/PressureTempVarTs.0.1.dsdl "
...
///
struct PressureTempVarTs_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 21UL;
        static constexpr std::size_t SerializationBufferSizeBytes = 21UL;
        ...
        struct TypeOf
        {
            ...
            using pressure = uavcan::si::unit::pressure::Scalar_1_0;
            using temperature = uavcan::si::unit::temperature::Scalar_1_0;
            using covariance_urt = std::array<float,3>;
        };
    };
    ...
    _traits_::TypeOf::pressure pressure{};

    _traits_::TypeOf::temperature temperature{};
    ///
...
inline nunavut::support::SerializeResult serialize(const PressureTempVarTs_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    const std::size_t capacity_bits = out_buffer.size();
    if ((static_cast<std::size_t>(capacity_bits)) < 168UL)
    {
    ...
    {   // uavcan.si.unit.pressure.Scalar.1.0 pressure
        ...
        auto _err0_ = serialize(obj.pressure, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
    ...
    {   // uavcan.si.unit.temperature.Scalar.1.0 temperature
        ...
        auto _err0_ = serialize(obj.temperature, _subspan0_.value());
        if (not _err0_)
        {
            return _err0_;
        }
...
inline nunavut::support::SerializeResult deserialize(PressureTempVarTs_0_1& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    // uavcan.si.unit.pressure.Scalar.1.0 pressure
    {
        std::size_t _size_bytes1_ = in_buffer.size() / 8U;
        {
            const auto _err1_ = deserialize(obj.pressure, in_buffer.subspan());
            if(_err1_){
                _size_bytes1_ = _err1_.value();
            }else{
                return -_err1_.error();
    ...
    // uavcan.si.unit.temperature.Scalar.1.0 temperature
    {
        std::size_t _size_bytes1_ = in_buffer.size() / 8U;
        {
            const auto _err1_ = deserialize(obj.temperature, in_buffer.subspan());
            if(_err1_){
                _size_bytes1_ = _err1_.value();
            }else{
                return -_err1_.error();
...
#endif // ZUBAX_PHYSICS_THERMODYNAMICS_PRESSURE_TEMP_VAR_TS_0_1_HPP_INCLUDED
