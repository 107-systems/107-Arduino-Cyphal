...
// Source file:   /tmp/zubax_dsdl/zubax/physics/dynamics/DoF3rdTs.0.1.dsdl
// Generated at:  2024-03-22 13:17:28.934149 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
#ifndef ZUBAX_PHYSICS_DYNAMICS_DO_F3RD_TS_0_1_HPP_INCLUDED
#define ZUBAX_PHYSICS_DYNAMICS_DO_F3RD_TS_0_1_HPP_INCLUDED

#include <nunavut/support/serialization.hpp>
#include <types/uavcan/time/SynchronizedTimestamp_1_0.hpp>
#include <types/zubax/physics/dynamics/DoF3rd_1_0.hpp>
#include <limits>
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/physics/dynamics/DoF3rdTs.0.1.dsdl "
...
struct [[deprecated("zubax.physics.dynamics.DoF3rdTs.0.1 is reaching the end of its life; there may be a newer version available")]]DoF3rdTs_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        static constexpr std::size_t ExtentBytes                  = 23UL;
        ...
        struct TypeOf
        {
            ...
            using value = zubax::physics::dynamics::DoF3rd_1_0;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const DoF3rdTs_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    const std::size_t capacity_bits = out_buffer.size();
    if ((static_cast<std::size_t>(capacity_bits)) < 184UL)
    {
...
inline nunavut::support::SerializeResult deserialize(DoF3rdTs_0_1& obj,
...
#endif // ZUBAX_PHYSICS_DYNAMICS_DO_F3RD_TS_0_1_HPP_INCLUDED
