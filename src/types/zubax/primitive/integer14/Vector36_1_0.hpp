...
// Source file:   /tmp/zubax_dsdl/zubax/primitive/integer14/Vector36.1.0.dsdl
// Generated at:  2024-03-22 13:17:28.758601 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ZUBAX_PRIMITIVE_INTEGER14_VECTOR36_1_0_HPP_INCLUDED
#define ZUBAX_PRIMITIVE_INTEGER14_VECTOR36_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/primitive/integer14/Vector36.1.0.dsdl "
...
struct Vector36_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using value = std::array<std::int16_t,36>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const Vector36_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated int14[36] value
        ...
        {
            std::int16_t _sat0_ = obj.value[_index1_];
            if (_sat0_ < -8192)
            {
                _sat0_ = -8192;
            }
...
inline nunavut::support::SerializeResult deserialize(Vector36_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    {
        obj.value[_index4_] = in_buffer.getI16(14U);
...
#endif // ZUBAX_PRIMITIVE_INTEGER14_VECTOR36_1_0_HPP_INCLUDED
