...
// Source file:   /tmp/zubax_dsdl/zubax/primitive/real32/Vector32.1.0.dsdl
// Generated at:  2024-03-22 13:17:28.743795 UTC
// Is deprecated: no
// Fixed port-ID: None
// Full name:     zubax.primitive.real32.Vector32
// Type Version:  1.0
// Support
...
#ifndef ZUBAX_PRIMITIVE_REAL32_VECTOR32_1_0_HPP_INCLUDED
#define ZUBAX_PRIMITIVE_REAL32_VECTOR32_1_0_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/primitive/real32/Vector32.1.0.dsdl "
...
struct Vector32_1_0 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using value = std::array<float,32>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const Vector32_1_0& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated float32[32] value
        const std::size_t _origin0_ = out_buffer.offset();
        for (std::size_t _index1_ = 0U; _index1_ < 32UL; ++_index1_)
        {
...
inline nunavut::support::SerializeResult deserialize(Vector32_1_0& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    const auto capacity_bits = in_buffer.size();
    // saturated float32[32] value
    for (std::size_t _index4_ = 0U; _index4_ < 32UL; ++_index4_)
    {
...
#endif // ZUBAX_PRIMITIVE_REAL32_VECTOR32_1_0_HPP_INCLUDED
