...
// Source file:   /tmp/zubax_dsdl/zubax/telega/DQ.0.1.dsdl
// Generated at:  2024-01-29 05:34:32.964650 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
#ifndef ZUBAX_TELEGA_DQ_0_1_HPP_INCLUDED
#define ZUBAX_TELEGA_DQ_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/telega/DQ.0.1.dsdl "
...
struct [[deprecated("zubax.telega.DQ.0.1 is reaching the end of its life; there may be a newer version available")]]DQ_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using current = std::array<float,2>;
...
inline nunavut::support::SerializeResult serialize(const DQ_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // truncated float16[2] current
        ...
        {
            auto _result4_ = out_buffer.setF16(obj.current[_index1_]);
            if(not _result4_){
    ...
    {   // truncated float16[2] voltage
        ...
        for (std::size_t _index1_ = 0U; _index1_ < 2UL; ++_index1_)
        {
            auto _result4_ = out_buffer.setF16(obj.voltage[_index1_]);
            if(not _result4_){
                return -_result4_.error();
            }
            out_buffer.add_offset(16U);
...
inline nunavut::support::SerializeResult deserialize(DQ_0_1& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    ...
    {
        obj.current[_index4_] = in_buffer.getF16();
        in_buffer.add_offset(16U);
    }
    // truncated float16[2] voltage
    for (std::size_t _index4_ = 0U; _index4_ < 2UL; ++_index4_)
    {
        obj.voltage[_index4_] = in_buffer.getF16();
        in_buffer.add_offset(16U);
    }
...
#endif // ZUBAX_TELEGA_DQ_0_1_HPP_INCLUDED
