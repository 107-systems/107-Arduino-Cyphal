...
// Source file:   /tmp/zubax_dsdl/zubax/telega/setpoint/Raw14x4.0.1.dsdl
// Generated at:  2024-01-29 05:34:32.986565 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
#ifndef ZUBAX_TELEGA_SETPOINT_RAW14X4_0_1_HPP_INCLUDED
#define ZUBAX_TELEGA_SETPOINT_RAW14X4_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/telega/setpoint/Raw14x4.0.1.dsdl "
...
struct [[deprecated("zubax.telega.setpoint.Raw14x4.0.1 is reaching the end of its life; there may be a newer version available")]]Raw14x4_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using raw = std::array<std::int16_t,4>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const Raw14x4_0_1& obj,
...
inline nunavut::support::SerializeResult deserialize(Raw14x4_0_1& obj,
...
#endif // ZUBAX_TELEGA_SETPOINT_RAW14X4_0_1_HPP_INCLUDED
