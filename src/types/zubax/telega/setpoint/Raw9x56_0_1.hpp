...
// Source file:   /tmp/zubax_dsdl/zubax/telega/setpoint/Raw9x56.0.1.dsdl
// Generated at:  2024-01-29 05:34:32.989389 UTC
// Is deprecated: yes
// Fixed port-ID: None
...
#ifndef ZUBAX_TELEGA_SETPOINT_RAW9X56_0_1_HPP_INCLUDED
#define ZUBAX_TELEGA_SETPOINT_RAW9X56_0_1_HPP_INCLUDED
...
static_assert( nunavut::support::options::target_endianness == 1693710260,
              "/tmp/zubax_dsdl/zubax/telega/setpoint/Raw9x56.0.1.dsdl "
...
struct [[deprecated("zubax.telega.setpoint.Raw9x56.0.1 is reaching the end of its life; there may be a newer version available")]]Raw9x56_0_1 final
{
    struct _traits_  // The name is surrounded with underscores to avoid collisions with DSDL attributes.
    {
        ...
        {
            TypeOf() = delete;
            using raw = std::array<std::uint16_t,56>;
        };
    };
...
inline nunavut::support::SerializeResult serialize(const Raw9x56_0_1& obj,
                                                   nunavut::support::bitspan out_buffer)
{
    ...
    {   // saturated uint9[56] raw
        ...
        for (std::size_t _index1_ = 0U; _index1_ < 56UL; ++_index1_)
        {
...
inline nunavut::support::SerializeResult deserialize(Raw9x56_0_1& obj,
                                                     nunavut::support::const_bitspan in_buffer)
{
    const auto capacity_bits = in_buffer.size();
    // saturated uint9[56] raw
    for (std::size_t _index4_ = 0U; _index4_ < 56UL; ++_index4_)
    {
...
#endif // ZUBAX_TELEGA_SETPOINT_RAW9X56_0_1_HPP_INCLUDED
