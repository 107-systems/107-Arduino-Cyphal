...
{
  ExecuteCommand_1_0_Request request = ExecuteCommand_1_0_Request::create(transfer);
  ...
  ExecuteCommand_1_0_Response response(ExecuteCommand_1_0_Response::Status::NOT_AUTHORIZED);
