...
static RegisterNatural8  reg_rw_uavcan_node_id          ("uavcan.node.id",           Register::Access::ReadWrite, false, OPEN_CYPHAL_NODE_ID, [&node_hdl](RegisterNatural8 const & reg) { node_hdl.setNodeId(reg.get()); });
static RegisterString    reg_ro_uavcan_node_description ("uavcan.node.description",  Register::Access::ReadWrite, false, "OpenCyphal-ToF-Distance-Sensor-Node", nullptr);
static RegisterNatural16 reg_ro_uavcan_pub_distance_id  ("uavcan.pub.distance.id",   Register::Access::ReadOnly,  false, OPEN_CYPHAL_ID_DISTANCE_DATA, nullptr);
static RegisterString    reg_ro_uavcan_pub_distance_type("uavcan.pub.distance.type", Register::Access::ReadOnly,  false, "uavcan.primitive.scalar.Real32.1.0", nullptr);
