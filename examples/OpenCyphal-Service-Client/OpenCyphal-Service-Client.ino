...
void    onExecuteCommand_1_0_Response_Received(CanardTransfer const &, Node &);
...
Node uc(13 /* local node id */, transmitCanFrame);
...
void onExecuteCommand_1_0_Response_Received(CanardTransfer const & transfer, Node & /* uc */)
{
